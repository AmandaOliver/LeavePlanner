...
{
	Task<AccessDenial> EnsureAdmin(string? email, CancellationToken cancellationToken);
	...
	Task<AccessDenial> EnsureManagerOfRequest(string? email, string? requestId, CancellationToken cancellationToken);
